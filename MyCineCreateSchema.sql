...
CREATE TABLE IF NOT EXISTS `myCine`.`UserFriends` (
  ...
  PRIMARY KEY (`id`),
  INDEX `friend_a_idx` (`frienda` ASC),
  INDEX `friend_b_idx` (`friendb` ASC),
  CONSTRAINT `friend_a`
    FOREIGN KEY (`frienda`)
    REFERENCES `myCine`.`users` (`id`),
  CONSTRAINT `friend_b`
...
-- -----------------------------------------------------
-- Table `myCine`.`friendrequests`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `myCine`.`friendrequests` (
  `idfriendrequests` INT(11) NOT NULL,
  `reqid` VARCHAR(128) NOT NULL,
  `usera` VARCHAR(45) NOT NULL,
  `userb` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idfriendrequests`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
