            ...
            <tr>
                <td colspan="3">
                    <form id="frm" action="/mycine/secure/auth/removelibrary" method="post" onsubmit="return validate();">
                        ...
                        <button type="button" onclick="setSource('Wishlist', 'Library', '${mvieTitle}', '${movie.movieid.idmovie}');">
                            <i class="fa fa-television">
                                <span>Move to Library</span>
                            </i>
                        </button>
                        <button type="button" onclick="setSource('Wishlist', 'trash', '${mvieTitle}', '${movie.movieid.idmovie}');">
                            <i class="fa fa-trash">
